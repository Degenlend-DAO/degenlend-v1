...
const FrequentlyAskedQuestions = () => {
    return (
        <Container sx={{
            ...
            <div>
                <Typography variant='h5' textAlign={'center'}>Frequently Asked Questions</Typography>
                <Accordion>
                    <AccordionSummary
                ...
                <Accordion>
                    ...
                    <AccordionDetails>
                        <Typography>
                            ...
                            Learn more in our docs <Link href="https://docs.degenlend.xyz/" target='_blank' sx={{ textDecoration: 'none' }}>here</Link>.
                        </Typography>
                    </AccordionDetails>
                </Accordion>
                <Accordion>
                ...
                <Accordion>
                    ...
                    <AccordionDetails>
                        <Typography>
                            ...
                            Check it out on our Github <Link href="https://github.com/Degenlend-DAO/DIPs" target='_blank' sx={{ textDecoration: 'none' }}>here.</Link>
                        </Typography>
                    </AccordionDetails>
                </Accordion>
            </div>
